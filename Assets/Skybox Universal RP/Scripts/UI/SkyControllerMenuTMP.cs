...
/// </summary>
[AddComponentMenu("Skybox URP/UI/Sky Controller Menu [TMP]")]
public class SkyControllerMenuTMP : MonoBehaviour
{
    #region === Fields ===
    ...
    private TMP_Text timeLabel; // Text displaying the time.

    [SerializeField, Tooltip("Dropdown to select the time progression mode.")]
    private TMP_Dropdown timeProgressionDropdown; // Dropdown for time progression mode.
    ...
    private TMP_InputField timeSpeedInput; // Input for time speed.

    [SerializeField, Tooltip("Input field to define the length of the day when using time-based progression.")]
    private TMP_InputField dayLengthInput; // Input for day length.
    ...
    /// </summary>
    public TMP_Dropdown TimeProgressionDropdown
    {
    ...
    /// </summary>
    public TMP_InputField TimeSpeedInput
    {
        get => timeSpeedInput;
    ...
    /// </summary>
    public TMP_InputField DayLengthInput
    {
        get => dayLengthInput;
    ...
    /// </summary>
    private void ConfigureInputField(TMP_InputField field)
    {
